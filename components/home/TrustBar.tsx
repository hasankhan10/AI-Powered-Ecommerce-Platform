...
export function TrustBar() {
  ...
  return (
    <section className="w-full bg-bg-deep border-y border-hairline py-12 md:py-16">
      <div className="mx-auto max-w-7xl px-6 lg:px-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-6 divide-y md:divide-y-0 md:divide-x divide-hairline">
          {stats.map((stat, idx) => {
